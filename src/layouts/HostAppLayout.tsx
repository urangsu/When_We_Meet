...
import { createThemeStyle, getAppThemePreset } from '../config/appThemePresets';
...
export const HostAppLayout = () => {
  ...
  const appTheme = getAppThemePreset(profile.appThemeId);
  const themeStyle = createThemeStyle(appTheme);
  ...
  return (
    <div style={themeStyle as any} className="min-h-dvh bg-bg-app md:flex md:justify-center md:py-6">
